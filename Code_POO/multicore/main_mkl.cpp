...
int main(int argc, char **argv) {
    ...
    plan.regions[14].set_targets(true,  46.00, 46.00, 48.00, 48.30, 47.00, -20, 50); // PTV 0-46Gy
    ...
    // // Prostate CK
    // plan.regions[ 0].set_targets( true, 31.00, 40.00, 50.00, 65.00, 60.00, -20,  20); // PTV 3 mm
    // plan.regions[ 1].set_targets(false,    -1,    -1,    -1, 41.80, 41.80,  10,  10); // Bladder
    ...
    // plan.regions[ 4].set_targets(false,    -1,    -1,    -1, 40.00, 40.00,  10,  10); // Urethra
    // plan.regions[ 5].set_targets(false,    -1,    -1,    -1,  4.00,  4.00,  10,   5); // Penis/Scrotum
    // plan.regions[ 6].set_targets(false,    -1,    -1,    -1, 38.00, 38.00,  10,  10); // Rectum
    // plan.regions[ 7].set_targets( true, 42.00, 45.00, 55.00, 69.16, 65.00, -20,  20); // PZ
